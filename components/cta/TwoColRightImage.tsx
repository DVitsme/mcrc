...
const TwoColRightImage = ({ title, description, subheader, image = "https://shadcnblocks.com/images/block/photos/pawel-czerwinski-O4fAgtXLRwI-unsplash.jpg", }: { title: string, description: string, subheader?: string, image: string }) => {
  return (
    <section className="">
