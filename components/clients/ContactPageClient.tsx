      ...
      <div className="center-container">
        ...
        <div className="mt-10 grid gap-4 md:mt-20 md:grid-cols-3 md:gap-8">
          <div className="flex flex-col justify-between gap-6 rounded-lg border p-6">
            <div>
              ...
              <a href="tel:+14435187693" className="text-muted-foreground hover:underline flex self-center pb-3">
                <Phone className="w-5 h-5 mr-2" />
                (443) 518-7693
              </a>
              <a href="mailto:info@mcrchoward.org" className="text-muted-foreground hover:underline flex self-center pb-3">
                <Mail className="w-5 h-5 mr-2" />
                info@mcrchoward.org
              </a>
              <a href="https://maps.app.goo.gl/9770PatuxentWoodsDriveSuite306ColumbiaMD21046" className="flex self-center text-muted-foreground hover:underline pb-3">
          ...
          <div className="flex flex-col justify-between gap-6 rounded-lg border p-6">
            <div>
              <h2 className="mb-4 text-xl font-medium md:text-2xl">Are you looking for services?</h2>
              <p className="text-muted-foreground">
                Click below to request a mediation session.
              </p>
            </div>
        ...
        <div className="mt-7">
          ...
          <div className="relative flex h-full flex-col overflow-hidden rounded-t-lg md:max-h-[496px] md:rounded-lg">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3092.8791792549832!2d-76.85494072349039!3d39.17746733012958!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89b7de412dd8c007%3A0xf4138df8f907b!2s9770%20Patuxent%20Woods%20Dr%2C%20Columbia%2C%20MD%2021046!5e0!3m2!1sen!2sus!4v1747512981460!5m2!1sen!2sus" width="800" height="600" style={{ border: 0, width: '100%', height: '496px' }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
          </div>
